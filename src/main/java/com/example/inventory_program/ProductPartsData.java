...
public class ProductPartsData {
    ...
    /**
     * Public ProductPartsData Constructor is called when the ProductData object is instantiated.
     * It has the function of initialize the newly created object before it is used.
     * The list of parameters that the public ProductPartsData constructor can take are declared into the parenthesis, and listed below:
     * @param partID is taken by public ProductPartsData Constructor, and initializes the private Integer partID variable.
     * @param part_name is taken by public ProductPartsData Constructor, and initializes the private String part_name variable.
     * @param stock is taken by public ProductPartsData Constructor, and initializes the private Integer stock variable.
     * @param price_unit is taken by public ProductPartsData Constructor, and initializes the private BigDecimal price_unit variable.
     */
    public ProductPartsData(Integer partID, String part_name, Integer stock,BigDecimal price_unit) {
        setPartID(partID);
